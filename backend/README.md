...
## Project Structure
    ...
    ├── testapiautosetting_125895  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125895`
...
2. Clone this repo and `cd testapiautosetting_125895`
